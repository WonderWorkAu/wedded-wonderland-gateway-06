    ...
    <div className="section-padding bg-wedding-off-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <Badge className="mb-4 px-3 py-1 bg-wedding-light-gray text-wedding-black border-wedding-medium-gray">
            Industry Leaders
          </Badge>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {memberCategories.map((category, index) => (
            <div key={index} className="bg-wedding-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300 border border-wedding-light-gray">
              <div className="bg-wedding-light-gray p-4 rounded-full inline-flex text-wedding-black mb-4">
                {category.icon}
              </div>
