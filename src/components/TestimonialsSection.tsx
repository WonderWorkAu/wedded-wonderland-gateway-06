    ...
    <div className="section-padding bg-wedding-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <div className="inline-block py-1 px-3 rounded-full bg-wedding-light-gray text-wedding-black text-sm font-medium mb-4 border border-wedding-medium-gray/30">
          ...
          <p className="text-lg text-wedding-charcoal max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="testimonial-card overflow-hidden group hover:shadow-2xl transition-all duration-300 bg-wedding-white">
              <div className="absolute top-0 left-0 h-1 w-full bg-gradient-gold"></div>
              <CardContent className="p-8">
                ...
                <p className="text-wedding-charcoal italic mb-6 text-lg leading-relaxed line-clamp-6">"{testimonial.quote}"</p>
                
                <div className="mt-6 mb-5 bg-wedding-off-white p-4 rounded-lg border border-wedding-light-gray transform group-hover:scale-105 transition-transform duration-300">
                ...
                <div className="mt-3 inline-block py-1 px-3 bg-wedding-light-gray rounded-full text-xs font-medium text-wedding-black border border-wedding-medium-gray/20">
